...
* Sales value
* Date of sale
* Operating profit (if provided)

This data represents Adidas product sales across the United States.
...
* Standardized column names and data types (date, text, number)
* Cleaned product and retailer fields
* Checked for missing values
* Formatted date column for time-based analysis
...
* A simple data model was used
* All insights were derived directly from the cleaned dataset
* No relationships or complex models were required
...
* **Bar/Column Charts:** Sales by region, retailer, and product
* **Line Chart:** Sales trend over time
* **Map Visual:** Sales distribution across US states/regions
* **Table:** Detailed view of sales records
* **Card Visuals:** Key summary statistics (Total Sales, Units Sold, etc.)
* **Slicers/Filters:** Region, product, retailer, year/month
...
* Which retailer contributed the most?
...
* Ability to import, clean, and format data
* Basic Power BI dashboard design
* Interactive reporting using visuals and slicers
* Skills in summarizing large datasets into easy-to-read insights
